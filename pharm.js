...
let id = Number(urlParams.search.split('?')[1])
console.log(id);
...
let filteredProducts = pharma.filter(item => item.id === id)
console.log(filteredProducts);

let img = document.querySelector('.pharma-img-img')
img.src = filteredProducts[0].img

let title = document.querySelector('.pharm-texts h1')
title.textContent = filteredProducts[0].title

let price = document.querySelector('.pharm-text-p')
price.textContent = filteredProducts[0].price

let discount = document.querySelector('.pharm-text-p-two span')
if (filteredProducts[0].discount) {
    discount.textContent = filteredProducts[0].oldPrice
}
let dic = document.querySelector('.dic')
dic.textContent = filteredProducts[0].discount